...
cv2.namedWindow('YOLO + CSRT Tracker v3 - No ROI Box', cv2.WINDOW_NORMAL)
cv2.setMouseCallback('YOLO + CSRT Tracker v3 - No ROI Box', mouse_callback)
...
while cap.isOpened():
    ...
    cv2.imshow('YOLO + CSRT Tracker v3 - No ROI Box', frame)
